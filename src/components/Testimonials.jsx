    ...
    <section className="py-12 sm:py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-4xl mx-auto hidden lg:block">
          ...
          <div className="absolute top-0 left-0 w-56 sm:w-64 p-4 bg-white rounded-2xl shadow-xl transform -translate-x-1/4 -translate-y-1/4 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
          ...
          <div className="absolute top-0 right-0 w-56 sm:w-64 p-4 bg-white rounded-2xl shadow-xl transform translate-x-1/4 -translate-y-1/4 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
            <FaQuoteLeft className="text-blue-500 text-2xl mb-2" />
          ...
          <div className="absolute bottom-0 left-0 w-56 sm:w-64 p-4 bg-white rounded-2xl shadow-xl transform -translate-x-1/4 translate-y-1/4 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
            <FaQuoteLeft className="text-blue-500 text-2xl mb-2" />
          ...
          <div className="absolute bottom-0 right-0 w-56 sm:w-64 p-4 bg-white rounded-2xl shadow-xl transform translate-x-1/4 translate-y-1/4 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
            <FaQuoteLeft className="text-blue-500 text-2xl mb-2" />
        ...
        <div className="grid sm:grid-cols-2 lg:hidden gap-4 mt-8">
          <div className="bg-white p-4 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
